...
hold on
for i = 1:length(E)
    plot(v(i),E(i),markers(i),'markersize',10,'LineWidth',1.6)
end
plot(rhovel,deltapsi/(2*gamma)*rhovel,'r','LineWidth',1.3)
xlabel('Momentum density (\rhov)')
ylabel('Equilibrium energy (E)')
axis([0,11,0,11])
legend('Hyperelastic/Topology 1','Hyperelastic/Topology 2','Hyperelastic/Topology 3','Linear/Topology 1', 'Linear/Topology 2','Linear/Topology 3', 'Lennard-Jones/Topology 1', 'Lennard-Jones/Topology 2','Lennard-Jones/Topology 3')